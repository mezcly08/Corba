 ...
 implements s_gestion_pacientes.sop_corba.GestionPersonalOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("existevaloracion", new java.lang.Integer (3));
    _methods.put ("consultarPaciente", new java.lang.Integer (4));
    _methods.put ("registrarPaciente", new java.lang.Integer (5));
    _methods.put ("abrirSesion", new java.lang.Integer (6));
    _methods.put ("registrarCallback", new java.lang.Integer (7));
    _methods.put ("valorarPaciente", new java.lang.Integer (8));
    _methods.put ("consultarValoracion", new java.lang.Integer (9));
    _methods.put ("existenPacientes", new java.lang.Integer (10));
    _methods.put ("eliminarCallback", new java.lang.Integer (11));
    _methods.put ("guardarInfoSesion", new java.lang.Integer (12));
    _methods.put ("consultarInfoSesion", new java.lang.Integer (13));
    _methods.put ("validarValoracion", new java.lang.Integer (14));
    _methods.put ("existeSesion", new java.lang.Integer (15));
    _methods.put ("eliminarList", new java.lang.Integer (16));
    _methods.put ("validarEstadoPaciente", new java.lang.Integer (17));
    _methods.put ("existenciaspersonal", new java.lang.Integer (18));
    _methods.put ("validaTodoVal", new java.lang.Integer (19));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // sop_corba/GestionPersonal/existevaloracion
       {
         int id = in.read_long ();
       ...
       case 4:  // sop_corba/GestionPersonal/consultarPaciente
       {
         int id = in.read_long ();
       ...
       case 5:  // sop_corba/GestionPersonal/registrarPaciente
       {
       ...
       case 6:  // sop_corba/GestionPersonal/abrirSesion
       {
       ...
       case 7:  // sop_corba/GestionPersonal/registrarCallback
       {
       ...
       case 8:  // sop_corba/GestionPersonal/valorarPaciente
       {
       ...
       case 9:  // sop_corba/GestionPersonal/consultarValoracion
       {
       ...
       case 10:  // sop_corba/GestionPersonal/existenPacientes
       {
         int id = in.read_long ();
         boolean $result = false;
       ...
       case 11:  // sop_corba/GestionPersonal/eliminarCallback
       {
       ...
       case 12:  // sop_corba/GestionPersonal/guardarInfoSesion
       {
       ...
       case 13:  // sop_corba/GestionPersonal/consultarInfoSesion
       {
         int id = in.read_long ();
       ...
       case 14:  // sop_corba/GestionPersonal/validarValoracion
       {
         int id = in.read_long ();
         String ocupacion = in.read_string ();
       ...
       case 15:  // sop_corba/GestionPersonal/existeSesion
       {
         int id = in.read_long ();
         boolean $result = false;
         $result = this.existeSesion (id);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 16:  // sop_corba/GestionPersonal/eliminarList
       {
         int id = in.read_long ();
         boolean $result = false;
       ...
       case 17:  // sop_corba/GestionPersonal/validarEstadoPaciente
       {
         String id = in.read_string ();
         boolean $result = false;
         $result = this.validarEstadoPaciente (id);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 18:  // sop_corba/GestionPersonal/existenciaspersonal
       {
         boolean $result = false;
         $result = this.existenciaspersonal ();
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 19:  // sop_corba/GestionPersonal/validaTodoVal
       {
         int id = in.read_long ();
         boolean $result = false;
         $result = this.validaTodoVal (id);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
