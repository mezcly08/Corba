 ...
 implements s_gestion_pacientes.sop_corba.GestionPersonalOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("valorarPaciente", new java.lang.Integer (4));
    _methods.put ("consultarValoracion", new java.lang.Integer (5));
    _methods.put ("existenPacientes", new java.lang.Integer (6));
    _methods.put ("eliminarCallback", new java.lang.Integer (7));
    _methods.put ("guardarInfoSesion", new java.lang.Integer (8));
    _methods.put ("consultarInfoSesion", new java.lang.Integer (9));
    _methods.put ("validarValoracion", new java.lang.Integer (10));
    _methods.put ("contador", new java.lang.Integer (11));
    _methods.put ("eliminarList", new java.lang.Integer (12));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // sop_corba/GestionPersonal/registrarCallback
       {
       ...
       case 4:  // sop_corba/GestionPersonal/valorarPaciente
       {
       ...
       case 5:  // sop_corba/GestionPersonal/consultarValoracion
       {
       ...
       case 6:  // sop_corba/GestionPersonal/existenPacientes
       {
         boolean $result = false;
       ...
       case 7:  // sop_corba/GestionPersonal/eliminarCallback
       {
       ...
       case 8:  // sop_corba/GestionPersonal/guardarInfoSesion
       {
       ...
       case 9:  // sop_corba/GestionPersonal/consultarInfoSesion
       {
         int id = in.read_long ();
       ...
       case 10:  // sop_corba/GestionPersonal/validarValoracion
       {
         int id = in.read_long ();
         String ocupacion = in.read_string ();
       ...
       case 11:  // sop_corba/GestionPersonal/contador
       {
         int id = in.read_long ();
         String ocupacion = in.read_string ();
         int $result = (int)0;
       ...
       case 12:  // sop_corba/GestionPersonal/eliminarList
       {
         int id = in.read_long ();
         boolean $result = false;
