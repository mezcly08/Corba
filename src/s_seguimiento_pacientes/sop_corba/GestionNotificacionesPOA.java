 ...
 implements s_seguimiento_pacientes.sop_corba.GestionNotificacionesOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("guardarValoracionPaciente", new java.lang.Integer (1));
    _methods.put ("guardarInfoSesion", new java.lang.Integer (2));
    _methods.put ("consultarInfoSesion", new java.lang.Integer (3));
  }
